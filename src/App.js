...
import snoopAlbum from './snoopAlbum'
          ...
          <div className='card swanky-input-container'>
            ...
            <div className='album-dropdown-base' onClick={this.toggleAlbumMenu}>
              {this.state.topAlbum === null ? (
                <span>Select the best album</span>
              ) : (
                [
                  <img src={this.state.topAlbum.cover} alt={this.state.topAlbum.name} key='img'/>,
